...
#(define chromatic-solfege-alist `((daes   . ,(ly:make-pitch -1 0  -8/4 ))
...
#(add! language-pitch-names `( aaron . , chromatic-solfege-alist ))
#(add! language-pitch-names `( chromatic-solfege . , chromatic-solfege-alist ))
...
#(define lookup-aaron-by-pitch
    (lambda (p)
        ...
        (lookup chromatic-solfege-alist p )))
...
#(define lookup-aaron-by-num
    (lambda ( pitch-algeration pitch-notename )
        ...
        (lookup chromatic-solfege-alist )))
