...
% var NOTE_TRIPLE_FLAT  = triple( [  dawf   rawf   mawf   fawf   sawf   lawf   tawf   ] );
% var NOTE_7QTR_FLAT    = triple( [  dawm   rawm   mawm   fawm   sawm   lawm   tawm   ] );
% var NOTE_6QTR_FLAT    = triple( [  daws   raws   maws   faws   saws   laws   taws   ] );
...
% var NOTE_6QTR_SHARP   = triple( [  dais   rais   mais   fais   sais   lais   tais   ] );
% var NOTE_7QTR_SHARP   = triple( [  daim   raim   maim   faim   saim   laim   taim   ] );
% var NOTE_TRIPLE_SHARP = triple( [  daif   raif   maif   faif   saif   laif   taif   ] );
