function chromatic( __settings, __object ) {
	var __defaultSettings = {
		noteEvent : noteEventPrefixTripleAccidental,
	};
	...
	var NOTE_QUADRUPLE_FLAT  = triple( [ 'daes','raes','maes','faes','saes','laes','taes', ] );
	...
	var NOTE_QUADRUPLE_SHARP = triple( [ 'daos','raos','maos','faos','saos','laos','taos', ] );
	...
	function transposeScript( value, settings  ) {
		var curr_settings = Object.assign( {}, 
				__defaultSettings, __settings, settings );
	...
	function noteEventPrefixTripleAccidental( n ) {
		if ( isTripleSharp( n ) ) {
	...
	Object.defineProperties( __object, 
		{
			...
			noteEventPrefixTripleAccidental : { value : noteEventPrefixTripleAccidental },
