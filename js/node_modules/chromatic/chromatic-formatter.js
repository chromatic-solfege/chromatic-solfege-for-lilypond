...
function init( __settings ) {
	...
	ScaleGenerator.prototype.writeScore = function () {
		...
		if ( curr_settings.queryFretDiagram ) {
	...
	ScaleGenerator.prototype.queryFretDiagram = function (notes, settings ) {
		console.error( settings );
		if ( settings == null ) {
			settings = {};
		}
		settings.queryFretDiagram = true;
		settings.formatType  = 'queryFretDiagram';
		return ScaleGenerator.prototype.writeScore.call( this, 'query'/*dummy*/, notes, settings );
	}
