...
function init( __settings ) {
	...
	ScaleGenerator.prototype.writeScore = function () {
		if ( this.developmentMode && this.disabled ) return;
	...
	ScaleGenerator.prototype.writeHeaderPart = function(caption) {
		if ( this.developmentMode && ( ! this.alwaysOutputHeader ) && this.disabled ) return;
		this.writeHeaderVoice('header-1', caption );
		this.writeIncludeText('\\part{' + caption + '}\n' );
	};
	...
	// writeCommand() outputs only tex commands but does not output voice commands.
