...
ScaleGenerator.applyTemplate =  function applyTemplate( noteArrays, sourceFilename, templatePath ) {
	 ...
	 * This modification breaks the specification that applyTemplate() function
	 * accepts noteArrays as an array object so that the multiple series of
	 * notes can be processed. This functionality is not used. If you are planning
	 * to use this functionality, this implementation must be re-implemented.
	 */
