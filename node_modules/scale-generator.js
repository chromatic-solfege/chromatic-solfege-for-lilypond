...
ScaleGenerator.applyTemplate =  function applyTemplate( arr, scale ) {
...
ScaleGenerator.prototype.writeScore1 = function ( type, notes ) {
	var id = notes.trim().split( /\s+/ ).shift();
