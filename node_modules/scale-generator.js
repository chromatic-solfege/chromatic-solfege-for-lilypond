...
//
ScaleGenerator.applyTemplate =  function applyTemplate( noteArrays, templatePath ) {
	// Note : note that templatePath canbe undefined. See solfege-template.ly .
	...
	return template( result, templatePath );
};
...
ScaleGenerator.prototype.writeScore = function () {
	...
	var output = ScaleGenerator.applyTemplate( notes, this.templatePath );
